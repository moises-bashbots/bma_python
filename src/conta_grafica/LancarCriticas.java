...
public class LancarCriticas {
	...
	public static void main(String[] args)
	{
		...
		RgbsysUser.readConf();
		ArrayList<Critica> criticas = Critica.criticasForRegister(connMaria, connMSS);
	...
	public static void setConnMaria(Connection connMaria) {
		LancarCriticas.connMaria = connMaria;
	}
	...
	public static void setConnMSS(Connection connMSS) {
		LancarCriticas.connMSS = connMSS;
	}
	...
	public static void setEmpresas(HashMap<String, Empresa> empresas) {
		LancarCriticas.empresas = empresas;
	}
	...
	public static void setCedentesPorEmpresa(HashMap<String, HashMap<String, Cedente>> cedentesPorEmpresa) {
		LancarCriticas.cedentesPorEmpresa = cedentesPorEmpresa;
	}
