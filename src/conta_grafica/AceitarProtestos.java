...
import rgbsys.RgbsysSeleniumProtesto;
import rgbsys.RgbsysUser;

public class AceitarProtestos {
	...
	public static void main(String[] args)
	{
		...
		RgbsysUser.readConf();
		RgbsysSeleniumProtesto rgbsysSeleniumProtesto = new RgbsysSeleniumProtesto();
		ArrayList<Critica> criticas = rgbsysSeleniumProtesto.protestar(connMaria, connMSS);
		rgbsysSeleniumProtesto.close();
	...
	public static void setConnMaria(Connection connMaria) {
		AceitarProtestos.connMaria = connMaria;
	}
	...
	public static void setConnMSS(Connection connMSS) {
		AceitarProtestos.connMSS = connMSS;
	}
	...
	public static void setEmpresas(HashMap<String, Empresa> empresas) {
		AceitarProtestos.empresas = empresas;
	}
	...
	public static void setCedentesPorEmpresa(HashMap<String, HashMap<String, Cedente>> cedentesPorEmpresa) {
		AceitarProtestos.cedentesPorEmpresa = cedentesPorEmpresa;
	}
